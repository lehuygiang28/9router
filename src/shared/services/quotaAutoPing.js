...
import { unlockConnectionIfQuotaRecovered } from "@/shared/services/quotaRoutingUnlock.js";
...
async function pingConnection(conn, provider, providerConfig, handler, deps, state = g) {
  ...
  await unlockConnectionIfQuotaRecovered(connection, usage, deps.updateProviderConnection);
